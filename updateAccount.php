...
<?php
	...
	$query = "SELECT * FROM accounts WHERE AccID='$id'";
...
<html>
<head>
<title>Update Account | Bank Customer Care System :: weboffy</title>
...
<!--- services --->	
     <div class="services sTop" id="services">
		...
		{
			?>
							 	 	    <form method="post" action="form_processing_Account_update.php?account_id=<?php echo $row["AccID"] ?>">
							 	 	    	<span><input type="text" name="cNum" value="<?php echo $row["aCustAccID"]?>" onfocus="this.value = '<?php echo $row["aCustAccID"]?>';" onblur="if (this.value == '') {this.value = 'Customer Number';}"><label><img src="images/con0.png" alt="" /></label></span>
							 	 	    	<span><input type="text" name="cAccNum" value="<?php echo $row["aAccNum"]?>" onfocus="this.value = '<?php echo $row["aAccNum"]?>';" onblur="if (this.value == '') {this.value = 'Account Number';}"><label><img src="images/con0.png" alt="" /></label></span>
										    	<span><input type="text" name="cAccType" value="<?php echo $row["aAccType"]?>" onfocus="this.value = '<?php echo $row["aAccType"]?>';" onblur="if (this.value == '') {this.value = 'Account Type';}"><label><img src="images/con1.png" alt="" /></label></span>
										    	<span><input type="date" name="cAccOpDate" value="<?php echo $row["aAccOpDate"]?>" onfocus="this.value = '<?php echo $row["aAccOpDate"]?>';" onblur="if (this.value == '') {this.value = 'Opening date';}"><label><img src="images/con4.png" alt="" /></label></span>									    
										    	<span><input type="text" name="cBal" value="<?php echo $row["aBalance"]?>" onfocus="this.value = '<?php echo $row["aBalance"]?>';" onblur="if (this.value == '') {this.value = 'Balance';}"><label><img src="images/con5.png" alt="" /></label></span>									    
