...
<html>
<head>
<title>Display Customer | Bank Customer Care System :: weboffy</title>
...
<!--- services --->	
     <div class="services sTop" id="services">
		  	<div class="wrap">
		  		...
		  		<p>Please see records from below</p>
		  		<table>
		...
		while($row = mysqli_fetch_assoc($result))
		{
			?>
					<tr>
		  				<td><?php echo $row["CdbBankID"]?></td>
		  				<td><?php echo $row["CdbName"]?></td>
		  				<td><?php echo $row["CdbFather"]?></td>
		  				<td><?php echo $row["CdbGender"]?></td>
		  				<td><?php echo $row["CdbCNIC"]?></td>
		  				<td><?php echo $row["CdbIntroducer"]?></td>
		  				<td><?php echo $row["CdbOwners"]?></td>
		  				<td><?php echo $row["CdbAddress"]?></td>
		  				<td><A target="_blank" HREF="getImage.php?customer_id=<?php echo $row["Cid"] ?>">Picture</A></td>
		  			</tr>
