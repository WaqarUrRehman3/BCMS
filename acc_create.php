...
<html>
<head>
<title>Create Account | Bank Customer Care System :: weboffy</title>
     ...
     <div class="services sTop" id="services">
		  	<div class="wrap">
		  		...
		  		<div class="contact_form">
							 	 	    <form method="post" action="form_processing_cAccount.php">
							 	 	    	<span><input type="text" name="cNum" value="Customer Number" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Customer Number';}"><label><img src="images/con0.png" alt="" /></label></span>
							 	 	    	<span><input type="text" name="cAccNum" value="Account Number" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Account Number';}"><label><img src="images/con0.png" alt="" /></label></span>
										    	<span><input type="text" name="cAccType" value="Account Type" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Account Type';}"><label><img src="images/con1.png" alt="" /></label></span>
										    	<span><input type="date" name="cAccOpDate" value="Opening date" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Opening date';}"><label><img src="images/con4.png" alt="" /></label></span>									    
										    	<span><input type="text" name="cBal" value="Balance" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Balance';}"><label><img src="images/con5.png" alt="" /></label></span>									    
