...
<html>
<head>
<title>Create Transaction | Bank Customer Care System :: weboffy</title>
     ...
     <div class="services sTop" id="services">
		  	<div class="wrap">
		  		...
		  		<div class="contact_form">
							 	 	    <form method="post" action="form_processing_ctransaction.php">
							 	 	    	<span><input type="text" name="tcNum" value="Customer Number" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Customer Number';}"><label><img src="images/con0.png" alt="" /></label></span>
							 	 	    	<span><input type="text" name="tid" value="Transaction Id" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Transaction Id';}"><label><img src="images/con0.png" alt="" /></label></span>
										    	<span><input type="text" name="tAccNum" value="Account Number" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Account Number';}"><label><img src="images/con1.png" alt="" /></label></span>
										    	<span><input type="text" name="tAmount" value="Transaction Amount" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Transaction Amount';}"><label><img src="images/con4.png" alt="" /></label></span>									    
										    	<span><input type="date" name="tDate" value="Transaction Date" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Transaction Date';}"><label><img src="images/con5.png" alt="" /></label></span>									    
