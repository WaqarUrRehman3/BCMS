...
<html>
<head>
<title>Accounts | Bank Customer Care System :: weboffy</title>
...
<!--- services --->	
     <div class="services sTop" id="services">
		  	<div class="wrap">
				...
				<div class="col_1_of_3 in_span_1_of_3">
					<img src="create.png" alt="">
					<h4><a href="acc_create.php">CREATE</a></h4>
					
				</div>

				<div class="col_1_of_3 in_span_1_of_3">
					<img src="remove.png" alt="">
					<h4><a href="acc_remove.php">REMOVE</a></h4>
					
				</div>
				<div class="col_1_of_3 in_span_1_of_3">
					<img src="update.png" alt="">
					<h4><a href="acc_update.php">UPDATE</a></h4>
					
				</div>
				<div class="col_1_of_3 in_span_1_of_3">
					<img src="display.png" alt="">
					<h4><a href="acc_display.php">DISPLAY</a></h4>
