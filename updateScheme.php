...
<?php
	...
	$query = "SELECT * FROM schemes WHERE sID='$id'";
...
<!--- services --->	
     <div class="services sTop" id="services">
		...
		{
			?>
							 	 	    <form method="post" action="form_processing_Scheme_update.php?scheme_id=<?php echo $row["sID"] ?>">
							 	 	    	<span><input type="text" name="scNum" value="<?php echo $row["dbsCustnum"]?>" onfocus="this.value = '<?php echo $row["dbsCustnum"]?>';" onblur="if (this.value == '') {this.value = 'Customer Number';}"><label><img src="images/con0.png" alt="" /></label></span>
							 	 	    	<span><input type="text" name="sid" value="<?php echo $row["dbsID"]?>" onfocus="this.value = '<?php echo $row["dbsID"]?>';" onblur="if (this.value == '') {this.value = 'Scheme Number';}"><label><img src="images/con0.png" alt="" /></label></span>
										    	<span><input type="text" name="sName" value="<?php echo $row["dbsName"]?>" onfocus="this.value = '<?php echo $row["dbsName"]?>';" onblur="if (this.value == '') {this.value = 'Scheme Name';}"><label><img src="images/con1.png" alt="" /></label></span>
										    	<span><input type="text" name="sDesc" value="<?php echo $row["dbsDesc"]?>" onfocus="this.value = '<?php echo $row["dbsDesc"]?>';" onblur="if (this.value == '') {this.value = 'Description';}"><label><img src="images/con4.png" alt="" /></label></span>									    
