...
$sql = "INSERT INTO customers (CdbBankID, CdbName, CdbFather, CdbGender, CdbCNIC, CdbIntroducer, CdbOwners, CdbImage, CdbAddress)
VALUES ('{$caccID}', '{$cname}', '{$cfatherName}', '{$cgender}', '{$ccnic}', '{$cintroducer}', '{$cnoOfOwners}', '{$image}', '{$caddress}')";
