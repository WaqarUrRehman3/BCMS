...
<html>
<head>
<title>Create Scheme | Bank Customer Care System :: weboffy</title>
     ...
     <div class="services sTop" id="services">
		  	<div class="wrap">
		  		...
		  		<div class="contact_form">
							 	 	    <form method="post" action="form_processing_cScheme.php">
							 	 	    	<span><input type="text" name="scNum" value="Customer Number" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Customer Number';}"><label><img src="images/con0.png" alt="" /></label></span>
							 	 	    	<span><input type="text" name="sid" value="Scheme Number" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Scheme id';}"><label><img src="images/con0.png" alt="" /></label></span>
										    	<span><input type="text" name="sName" value="Scheme Name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Scheme Name';}"><label><img src="images/con1.png" alt="" /></label></span>
										    	<span><input type="text"name="sDesc" value="Description" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Discription';}"><label><img src="images/con5.png" alt="" /></label></span>									    
