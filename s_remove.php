...
<html>
<head>
<title>Remove Scheme | Bank Customer Care System :: weboffy</title>
		  			...
		  			while($row = mysqli_fetch_assoc($result))
		{
			?>
					<tr>
		  				...
		  				<td><A target="_blank" HREF="form_processing_Scheme_delete.php?scheme_id=<?php echo $row["sID"] ?>">DELETE</A></td>
		  			</tr>
