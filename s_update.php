...
<html>
<head>
<title>Update Scheme | Bank Customer Care System :: weboffy</title>
...
<!--- services --->	
     <div class="services sTop" id="services">
		  			...
		  			while($row = mysqli_fetch_assoc($result))
		{
			?>
					<tr>
		  				<td><?php echo $row["dbsID"]?></td>
		  				<td><?php echo $row["dbsName"]?></td>
		  				
		  				<td><A target="_blank" HREF="updateScheme.php?scheme_id=<?php echo $row["sID"] ?>">UPDATE</A></td>
		  			</tr>
