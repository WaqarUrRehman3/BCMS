...
<html>
<head>
<title>Update Transaction | Bank Customer Care System :: weboffy</title>
...
<!--- services --->	
     <div class="services sTop" id="services">
		...
		{
			?>
							 	 	    <form method="post" action="form_processing_Transaction_update.php?transaction_id=<?php echo $row["tID"] ?>">
							 	 	    	<span><input type="text" name="tcNum" value="<?php echo $row["dbtCustNum"]?>" onfocus="this.value = '<?php echo $row["dbtCustNum"]?>';" onblur="if (this.value == '') {this.value = 'Customer Number';}"><label><img src="images/con0.png" alt="" /></label></span>
							 	 	    	<span><input type="text" name="tid" value="<?php echo $row["dbtID"]?>" onfocus="this.value = '<?php echo $row["dbtID"]?>';" onblur="if (this.value == '') {this.value = 'Transaction Id';}"><label><img src="images/con0.png" alt="" /></label></span>
										    	<span><input type="text" name="tAccNum" value="<?php echo $row["dbtAccNum"]?>" onfocus="this.value = '<?php echo $row["dbtAccNum"]?>';" onblur="if (this.value == '') {this.value = 'Account Number';}"><label><img src="images/con1.png" alt="" /></label></span>
										    	<span><input type="text" name="tAmount" value="<?php echo $row["dbtAmount"]?>" onfocus="this.value = '<?php echo $row["dbtAmount"]?>';" onblur="if (this.value == '') {this.value = 'Transaction Amount';}"><label><img src="images/con4.png" alt="" /></label></span>									    
										    	<span><input type="date" name="tDate" value="<?php echo $row["dbtDate"]?>" onfocus="this.value = '<?php echo $row["dbtDate"]?>';" onblur="if (this.value == '') {this.value = 'Transaction Date';}"><label><img src="images/con5.png" alt="" /></label></span>									    
