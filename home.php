<?php
session_start();
$redirect_page_failure = 'http://tiffinwala.pk/index.php';
$redirect_page_success = 'http://tiffinwala.pk/web/home.php';
if(isset($_SESSION['login_status'])==false){
	header('Location:'.$redirect_page_failure);
}
?>
<!DOCTYPE HTML>
<html>
<head>
<title>Home | Bank Customer Care System :: weboffy</title>
     ...
     <div class="services sTop" id="services">
		  	<div class="wrap">
				...
				<div class="col_1_of_3 span_1_of_3">
					...
					<h4><a href="customer.php">CUSTOMERS</a></h4>
				...
				<div class="col_1_of_3 span_1_of_3">
					...
					<h4><a href="scheme.php">SCHEMES</a></h4>
					
				</div>
				<div class="col_1_of_3 span_1_of_3">
					<img src="introducer.png" alt="">
					<h4><a href="introducer.php">INTRODUCERS</a></h4>
					
				</div>
				<div class="col_1_of_3 span_1_of_3">
					<img src="transaction.png" alt="">
					<h4><a href="transaction.php">TRANSACTIONS</a></h4>
