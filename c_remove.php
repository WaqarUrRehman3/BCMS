...
<html>
<head>
<title>Remove Customer | Bank Customer Care System :: weboffy</title>
		  		...
		  		while($row = mysqli_fetch_assoc($result))
		{
			?>
					<tr>
		  				...
		  				<td><A target="_blank" HREF="form_processing_cCustomer_delete.php?customer_id=<?php echo $row["Cid"] ?>">DELETE</A></td>
		  			</tr>
