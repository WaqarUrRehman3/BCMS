...
<html>
<head>
<title>Create Customer | Bank Customer Care System :: weboffy</title>
     ...
     <div class="services sTop" id="services">
		  	<div class="wrap">
		  		...
		  		<div class="contact_form">
							 	 	    <form method="post" action="form_processing_cCustomer.php" enctype="multipart/form-data">
							 	 	    	<span><input type="text" name="accID" value="ID" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'ID';}"><label><img src="images/con0.png" alt="" /></label></span>
										    	<span><input type="text" name="name" value="NAME" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'NAME';}"><label><img src="images/con1.png" alt="" /></label></span>
										    	<span><input type="text" name="fatherName" value="FATHER NAME" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'FATHER NAME';}"><label><img src="images/con4.png" alt="" /></label></span>									    
										    	<span><input type="text" name="gender" value="GENDER" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'GENDER';}"><label><img src="images/con5.png" alt="" /></label></span>									    
										    	<span><input type="text" name="cnic" value="CNIC" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'CNIC';}"><label><img src="images/con6.png" alt="" /></label></span>
										    	<span><input type="text" name="introducer" value="INTRODUCERS ACCOUNT NUMBER" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'INTRODUCERS ACCOUNT NUMBER';}"><label><img src="images/con1.png" alt="" /></label></span>
										    	<span><input type="text" name="noOfOwners" value="NUMBER OF OWNERS" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'NUMBER OF OWNERS';}"><label><img src="images/con1.png" alt="" /></label></span>
										    	
										    	
										    	<span><input type="file" name="fileToUpload" id="fileToUpload"><label><img src="images/con1.png" alt="" /></label></span>
										    	
										    <div class="clear"></div>
										    	<span><textarea name="address" placeholder="PERMANENT ADDRESS"></textarea><label1><img src="images/con2.png" alt="" /></label1></span>
