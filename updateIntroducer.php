...
<?php
	...
	$query = "SELECT * FROM introducers WHERE iID='$id'";
...
<html>
<head>
<title>Update Introducer | Bank Customer Care System :: weboffy</title>
...
<!--- services --->	
     <div class="services sTop" id="services">
		...
		{
			?>
							 	 	    <form method="post" action="form_processing_Introducer_update.php?introducer_id=<?php echo $row["iID"] ?>">
							 	 	    	<span><input type="text" name="icNum" value="<?php echo $row["dbiCustNum"]?>" onfocus="this.value = '<?php echo $row["dbiCustNum"]?>';" onblur="if (this.value == '') {this.value = 'Customer Number';}"><label><img src="images/con0.png" alt="" /></label></span>
							 	 	    	<span><input type="text" name="iAccNum" value="<?php echo $row["dbiIntoAccNum"]?>" onfocus="this.value = '<?php echo $row["dbiIntoAccNum"]?>';" onblur="if (this.value == '') {this.value = 'Introducer's Account Number';}"><label><img src="images/con0.png" alt="" /></label></span>
										    	<span><input type="text" name="iName" value="<?php echo $row["dbiName"]?>" onfocus="this.value = '<?php echo $row["dbiName"]?>';" onblur="if (this.value == '') {this.value = 'Introducer's NAME';}"><label><img src="images/con1.png" alt="" /></label></span>
