...
<html>
<head>
<title>Remove Account | Bank Customer Care System :: weboffy</title>
		  			...
		  			while($row = mysqli_fetch_assoc($result))
		{
			?>
					<tr>
		  				...
		  				<td><A target="_blank" HREF="form_processing_Account_delete.php?account_id=<?php echo $row["AccID"] ?>">DELETE</A></td>
		  			</tr>
